...
"#endif\n",
"\n",
"uniform highp float ClientTime; // Baker r0082 + \n",
"\n",
"void main(void)\n",
"{\n",
// Baker r_waterwarp2 and colorfringe cannot be used at same time
// with this as-is
"#ifdef R_WATERWARP_2 // Baker + \n",
"	float xAngle = ClientTime * 2 + (1.0 - TexCoord1.y) * 4.7; \n",
"	float yAngle = ClientTime * 1 + TexCoord1.x * 3; \n",
" \n",
"	vec2 distortOffset = \n",
"		(vec2(sin(xAngle), sin(yAngle)) * vec2(.025,.025)) * .75; // amount of shearing, magnitude adjustment \n",
" \n",
"	dp_FragColor = dp_texture2D(Texture_First, TexCoord1 + distortOffset); \n",
"#else \n"
...
"#endif\n",
"#endif // R_WATERWARP_2 Baker r0082 \n",
"\n",
"#ifdef USEFXAA\n",
...
"	// Baker:DIRECTO -- position comes from pixel half3 is a float 16 vector position is a variable 1236 calculated from texture  \n",
"	// Baker:cast_myhalf3 is vec3 .. vec3 is float 32  \n",
"	// Baker:So where is this eyenormal used -- its in the SHADESPECULAR macro \n",
"	// Baker:myhalf4 normalmap probably float 32\n",
...
"#else\n",
// Baker r0083: r_waterdeform re-uses USESATURATION without overlap
"	#ifdef USESATURATION  // Water deform mod Baker + \n",
"		float xAngle = ClientTime * 2 + (1.0 - TexCoordSurfaceLightmap.y) * 10; \n", 
"		float yAngle = ClientTime * 2 + TexCoordSurfaceLightmap.x * 10; \n",
"		vec2 distortOffset = \n",
"			(vec2(sin(xAngle), sin(yAngle)) * vec2(.025,.025)) * .75; \n",
"		# define offsetMappedTexture2D(t) dp_texture2D(t, TexCoordSurfaceLightmap.xy + distortOffset) \n",
"		# define TexCoord TexCoordSurfaceLightmap.xy + distortOffset \n",
"	#else \n",
		"# define offsetMappedTexture2D(t) dp_texture2D(t, TexCoordSurfaceLightmap.xy)\n",
