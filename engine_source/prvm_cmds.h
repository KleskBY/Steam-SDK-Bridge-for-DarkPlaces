...
#define VM_SAFEPARMCOUNTRANGE(p1,p2,f)	if (prog->argc < p1 || prog->argc > p2) prog->error_cmd(#f " wrong parameter count %d (" #p1 " to " #p2 " expected ) !", prog->argc)
#define VM_SAFEPARMCOUNT(p,f)	if (prog->argc != p) prog->error_cmd(#f " wrong parameter count %d (" #p " expected ) !", prog->argc)
#else
...
// Baker - ZIRCON_FORMS_V1

void VM_CL_Form_Load (prvm_prog_t *prog); // 180
void VM_CL_Form_Property_Set_String (prvm_prog_t *prog); // 181
void VM_CL_Form_Property_Get_String (prvm_prog_t *prog); // 182
void VM_CL_Form_Close (prvm_prog_t *prog); // 183
void VM_CL_Form_Command (prvm_prog_t *prog); // 184 form_command (f, "hide");
void VM_CL_Form_Property_Set_Float (prvm_prog_t *prog); // 185
void VM_CL_Form_Property_Get_Float (prvm_prog_t *prog); // 186
void VM_FS_FileInfo (prvm_prog_t *prog); // 190
void VM_FS_GetGameDir (prvm_prog_t *prog); // 191

void VM_stobase64 (prvm_prog_t *prog); // 192
void VM_base64tos (prvm_prog_t *prog); // 193
...
// Baker - ZIRCON_DUNGEON_V1
void VM_map_load (prvm_prog_t *prog); // 150
void VM_map_move  (prvm_prog_t *prog); // 151
void VM_map_append_map  (prvm_prog_t *prog); // 152
void VM_map_save_as (prvm_prog_t *prog); // 153
void VM_map_clipboard_set (prvm_prog_t *prog); // 154
void VM_map_compile_with_callback (prvm_prog_t *prog); // 155
void VM_map_prefix_fields_values (prvm_prog_t *prog); // 156
void VM_map_close (prvm_prog_t *prog); // 157

void VM_map_entity_count (prvm_prog_t *prog); // 158
void VM_map_find_entity (prvm_prog_t *prog); // 159

void VM_map_entity_key_count (prvm_prog_t *prog); // 160
void VM_map_entity_key_for_index (prvm_prog_t *prog); // 161
void VM_map_entity_key_get_value (prvm_prog_t *prog); // 162
void VM_map_entity_key_set_value (prvm_prog_t *prog); // 163
void VM_map_entity_get_mins_maxs (prvm_prog_t *prog); // 164


void VM_map_entity_keyvalue_for_index (prvm_prog_t *prog); // 166

// Limits are good don't do these until the future ... they are nice but not necessary.
//              entity copy 171
//				entity move 167
//				entity delete 168
//				entity key remove 170?
//				texture manipulation?  Brush manipulation?
void VM_map_entity_add (prvm_prog_t *prog); // 169 - copy single entity
void VM_map_texture_replace (prvm_prog_t *prog); // 171
...
void VM_DungeonMake (prvm_prog_t *prog);
void VM_DungeonStatus (prvm_prog_t *prog);
