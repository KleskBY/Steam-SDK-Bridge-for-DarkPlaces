...
{
	dp_font_t *f;
	int maxsize_font;	// Baker: Allocated.  Starts at 16, expands by 8.
}
dp_fonts_t;
...
float DrawQ_String(float x, float y, ccs *text, size_t maxlen, float scalex, float scaley, float basered, float basegreen, float baseblue, float basealpha, int flags, int *outcolor, qbool ignorecolorcodes, const dp_font_t *fnt);
float DrawQ_String_Scale(float x, float y, ccs *text, size_t maxlen, float sizex, float sizey, float scalex, float scaley, float basered, float basegreen, float baseblue, float basealpha, int flags, int *outcolor, qbool ignorecolorcodes, const dp_font_t *fnt);
...
float DrawQ_TextWidth_UntilWidth_TrackColors(ccs *text, size_t *maxlen, float w, float h, int *outcolor, qbool ignorecolorcodes, const dp_font_t *fnt, float maxwidth);
float DrawQ_TextWidth_UntilWidth_TrackColors_Scale(ccs *text, size_t *maxlen, float w, float h, float sw, float sh, int *outcolor, qbool ignorecolorcodes, const dp_font_t *fnt, float maxwidth);
