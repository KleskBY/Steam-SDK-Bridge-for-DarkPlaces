...
extern struct cvar_s r_skyfog; // Baker r1201: FitzQuake r_skyfog
...
extern int scr_loading_ex;

#define SCR_LOADING_NOT_0		0
#define SCR_LOADING_ENGINE_1	1
#define SCR_LOADING_MENUQC_2	2
