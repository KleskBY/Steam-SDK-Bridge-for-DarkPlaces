...
extern cvar_t vid_fullscreen_conscale;	// Baker: autoscale
extern cvar_t vid_window_conscale;		// Baker: autoscale
extern cvar_t vid_magnification_factor;	// Baker: autoscale
...
#if 0 // Baker: I am pretty sure we decided on a different method
