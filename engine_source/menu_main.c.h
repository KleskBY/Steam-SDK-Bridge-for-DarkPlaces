...
static void M_Main_Draw (void)
{
	...
	M_DrawPic ( (320-Draw_GetPicWidth(p0))/2, 4, "gfx/ttl_main", HOTSPOTS_NONE_0, NA0, NA0);
// Nehahra
	if (gamemode == GAME_NEHAHRA) {
	...
	M_DrawPic (54, 32 + local_cursor * 20, va(vabuf, sizeof(vabuf), "gfx/menudot%d", f+1), HOTSPOTS_NONE_0, NA0, NA0);
}
