...
#define Vector3Compare(a,b) VectorCompare(a,b)

#define DotProduct4(a,b) ((a)[0]*(b)[0]+(a)[1]*(b)[1]+(a)[2]*(b)[2]+(a)[3]*(b)[3])
#define Vector4Clear(a) ((a)[0]=(a)[1]=(a)[2]=(a)[3]=0)
#define Vector4Compare(a,b) (((a)[0]==(b)[0])&&((a)[1]==(b)[1])&&((a)[2]==(b)[2])&&((a)[3]==(b)[3]))
#define Vector4Copy(a,b) ((b)[0]=(a)[0],(b)[1]=(a)[1],(b)[2]=(a)[2],(b)[3]=(a)[3])
#define Vector4CopyDestSrc(a,b) ((a)[0]=(b)[0],(a)[1]=(b)[1],(a)[2]=(b)[2],(a)[3]=(b)[3])
...
#define Vector3_IsZeros(v) (((v)[0] == 0) && ((v)[1] == 0) && ((v)[2] == 0)) // DON'T USE ME?
#define Vector3_IsNotZeros(v) (((v)[0] != 0) || ((v)[1] != 0) || ((v)[2] != 0)) // USE ME RIGHT, TRIVIALLY FASTER IN MANY CASES DUE TO SHORT CIRCUITING 

#define Vector6Set(a,b,c,d,e,f,g) ((a)[0]=(b),(a)[1]=(c),(a)[2]=(d),(a)[3]=(e),(a)[4]=(f),(a)[5]=(g)) // OCT 2 2024
#if 0
#define Vector6Copy(a,b) ((b)[0]=(a)[0],(b)[1]=(a)[1],(b)[2]=(a)[2],(b)[3]=(a)[3],(b)[4]=(a)[4],(b)[5]=(a)[5])
#endif

#define Vector6CopyDestSrc(a,b) ((a)[0]=(b)[0],(a)[1]=(b)[1],(a)[2]=(b)[2],(a)[3]=(b)[3],(a)[4]=(b)[4],(a)[5]=(b)[5])

#define VectorEquals(v,a,b,c) (v[0] == (a) && v[1] == (b) && v[2] == (c)) // Baker
...
// Baker: BoxesOverlap2D
#define BoxesOverlap2D(aamins,bamaxs,cbmins,dbmaxs) \
	((aamins)[0] <= (dbmaxs)[0] && \
	(bamaxs)[0] >= (cbmins)[0] && \
	(aamins)[1] <= (dbmaxs)[1] && (bamaxs)[1] >= (cbmins)[1]) // Ender
...
int Math_atov_vm(const char *s, prvm_vec3_t out); // Baker: prvm_vec3_t vs. vec3_t
int Math_atov3 (ccs *s, vec3_t out);
int Math_atov4 (ccs *s, vec4_t out);
