...
extern cvar_t r_modellight_players_nocolor;
extern cvar_t r_modellight_monsters_noccolor;
extern cvar_t r_modellight_viewmodels_nocolor;
extern cvar_t r_modellight_players_nocolor_minlight;
extern cvar_t r_modellight_monsters_noccolor_minlight;
extern cvar_t r_modellight_viewmodels_nocolor_minlight;
...
#if 1 // Baker: Feb 6 2025
	RELATED_ (VF_CLEARCOLOR_99)
	qbool isbclearcolor;
	vec4_t bclearcolor;
#endif
...
#define FOGMASKTABLEWIDTH 1024
	...
	float fog_density;
	float fog_density0; // Baker r1201: FitzQuake r_skyfog
	float fog_red;
	float fog_green;
	float fog_blue;
	float fog_alpha;
...
extern rtexture_t *r_texture_mapcube;
extern char r_texture_mapcube_name[MAX_QPATH_128]; // Not Q3PATHLENGTH_64 - clear this on gamedir change.
