...
//#define PRVM_64
	...
	#if defined(_MSC_VER) && _MSC_VER < 1900
		#define PRVM_PRIi "d" // Baker: Another one fixed formerly "%d"
		#define PRVM_PRIu "u" // Baker: Another one fixed formerly "%u"
	#else
...
typedef struct {
	vec3_t mins, maxs, dims;
} size_pack_3_s; // Baker: May 31 2025
