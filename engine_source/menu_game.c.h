...
// Baker: April 27 2025 - What the fuck is this?
static gameinfo_t gamelist[] =
{
	{GAME_NORMAL_0, &sharewarequakegame, &registeredquakegame},
	...
	{GAME_GALAXY, &goodvsbad2game, &goodvsbad2game},
...
void M_Menu_GameOptions_f(cmd_state_t *cmd)
{
	...
	// pick game level list based on gamemode (use GAME_NORMAL_0 if no matches)
	gameoptions_levels = registered.integer ? gamelist[0].registered : gamelist[0].notregistered;
	for (i = 0; i < (int)ARRAY_COUNT(gamelist); i ++)
...
void M_GameOptions_Draw (void)
{
	...
	M_DrawPic ( (320-Draw_GetPicWidth(p0))/2, 4, "gfx/p_multi", HOTSPOTS_NONE_0, NA0, NA0);
