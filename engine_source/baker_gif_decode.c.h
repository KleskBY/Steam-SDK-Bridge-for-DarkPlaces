...
int bakergifdecode_videoframe (clvideo_t *video, void *stream, /*Baker: Dest*/ void *imagedata, 
...
RELATED_ (dpvsimpledecode_open OpenStream gd_open_gif_alloc bakergifdecode_videoframe SCR_gifclip_f)
void *bakergifdecode_open (clvideo_t *video, char *filename, const char **perrorstring)
{
	...
	gifstream_t *s_a	= (gifstream_t *)ZAlloc_VoidP_SizeOf(gifstream_t);
