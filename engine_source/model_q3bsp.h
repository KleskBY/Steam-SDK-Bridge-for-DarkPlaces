...
typedef struct q3deffect_s
{
	...
	int brushindex;
	int unknown_q3_field; // I read this is always 5 except in q3dm8 which has one effect with -1
}
q3deffect_t;

// Baker: Q3FACETYPE_FLARE_4 is not supported in DP
...
typedef struct model_brushq3_s
{
	...
	int num_effects;
	q3deffect_t *data_effects; // Baker: Compile time effects (surfaceflags in texture_t)
