...
RELATED_ (clc_zircon_warp_ack, svc_zircon_warp)
...
RELATED_ (qw_clc_stringcmd)		// also 4
...
#define RENDER_SOLID_NOT_BAKER_256		256		// S8 Baker: 256 SOLID_NOT, SOLID_TRIGGER

// Baker: The intent here is for CSCQ traceline to be able to collide with these
// (even if non-solid such as healthbox which is SOLID_TRIGGER_1)

#define RENDER_FL_INTERACTIVE_512		512		// S9 Baker: An extra flag to mark items.
...
typedef struct entity_state_s
{
	...
	RELATED_ (qw_monsters MONSTER_QW_ARMY_0 GE_MONSTERTYPEQW_505 GE_MONSTERCHAIN_EX_513)
...
RELATED_ (PEXT_256PACKETENTITIES)
...
RELATED_ (PROTOCOL_VERSION_FTE1, PROTOCOL_VERSION_QW_28, FTE_EXTENSIONS_SUPPORTED_CL)
