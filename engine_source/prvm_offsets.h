...
#if 0 // Baker: Wrath has (DP no .. fires before "clientcommandframe is updated" in FTE docs)
PRVM_DECLARE_function(CSQC_Input_Frame)
#endif
...
#if 0 // Baker: Wrath has this as CSQC function
...
PRVM_DECLARE_function(m_drawloading) // From Wrath
...
#if 0 // Baker: Wrath has 64 parm support it seems
...
PRVM_DECLARE_menufunction(m_drawloading)
#if 0 // Baker: Wrath has support for drawing a loading screen
PRVM_DECLARE_menufunction(m_drawloading)
#endif
...
#if 0 // Baker: Wrath has - DP does not
...
#if 0 // Wrath has
PRVM_DECLARE_serverglobalfloat(input_buttons)
PRVM_DECLARE_serverglobalfloat(input_timelength)
PRVM_DECLARE_serverglobalfloat(input_impulse)
#endif
...
#if 0 // Baker: Wrath has and is a dup (DP already had)
PRVM_DECLARE_serverglobalfloat(servercommandframe)
#endif
...
#if 0 // Baker: Wrath has (these can't be right .. that's CL)
PRVM_DECLARE_serverglobalvector(input_angles)
PRVM_DECLARE_serverglobalvector(input_movevalues)
#endif
