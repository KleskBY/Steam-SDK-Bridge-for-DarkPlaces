...
#define Con_PrintLineEmpty() Con_Print (NEWLINE)
#define Con_DPrintLineEmpty() Con_Print (NEWLINE)

#define Con_PrintVarTitleBBOX(SLITERAL,bmins,bmaxs) \
	Con_PrintLinef (SLITERAL VECTOR3BBOX_G, VECTOR3BBOX_SEND(imins,imaxs))
...
#define CON_WHITE		"^7"
#define CON_YELLOW		"^xFF0"
#define CON_GRAY_50		"^x888"	// colormod, movetype, solid in "edict 22" use this to note enum
...
RELATED_ (con, history)  // Baker: Both of these are conbuffer_t
...
extern qbool m_maplist_type_is_menu;
