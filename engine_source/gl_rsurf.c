...
cvar_t r_usefrustumculling = {CF_CLIENT, "r_usefrustumculling", "1", "disables frustum culling [Zircon]"};
...
===============
*/
// LM_OID 2 - May 10 2025 .. does Q3 come here at all? Yes but updates flags is always 0
// A: Baker May 10 2025 - Q3 does not come here at all.
// Reason is no model->brushq1.num_lightstyles
...
// add all the lightmaps
	...
	// Baker: LM_OID - Q1 only? Never hits for Q3 April 5 2025 ... never will move long ...
...
RELATED_ (R_Mod_DrawDepth ->DrawDepth  r_depthfirst.integer >= 2)
